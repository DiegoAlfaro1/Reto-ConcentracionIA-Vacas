...
S3_PREFIX_PROCESSED_DAT = os.getenv("S3_PREFIX_PROCESSED_DAT", "processed/").lstrip("/")
AWS_REGION = os.getenv("AWS_DEFAULT_REGION", "us-east-1")

# Construye el URI S3 completo
S3_URI = f"s3://{S3_BUCKET}/{S3_PREFIX_PROCESSED_DAT}registros_sesiones_merged.csv"
